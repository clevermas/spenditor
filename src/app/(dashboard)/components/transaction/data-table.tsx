              ...
              return (
                <div
                  ...
                  className={
                    ...
                    (readonly
                      ? "grid-cols-[minmax(58%,1fr)_30%] md:grid-cols-[minmax(200px,30%)_minmax(120px,1fr)_100px]"
                      : "grid-cols-[minmax(58%,1fr)_30%_16px] md:grid-cols-[minmax(100px,30%)_minmax(120px,1fr)_100px_25px]" 
                    )
                  }
                >
                  {row
